...
import type { FeedntFriend } from '@feednt/hooks/useFeedntFriendships.ts';

type FeedntRecipientsInput = {
  viewerKeyId: string | null;
  friends: FeedntFriend[];
...
export function useFeedntRecipients({
  viewerKeyId,
  friends,
  loadingFriends,
  friendsError,
}: FeedntRecipientsInput) {
