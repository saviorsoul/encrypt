 ...
 *
 * Usage:
 *   node apps/encrypt/desktop/scripts/check-encrypt-protocol.mjs
 *   REQUIRE_OS_HANDLER=1 node apps/encrypt/desktop/scripts/check-encrypt-protocol.mjs
 *
...
function checkPackaging() {
  ...
  const mainJs = fs.readFileSync(path.join(desktopRoot, 'electron/main.js'), 'utf8');
